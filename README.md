...
This repository has been copied from this [link](https://github.com/noraj/OSCP-Exam-Report-Template-Markdown)
...
Rename the eisvogel.tex file to eisvogel.latex  and move it to the directory 
/usr/share/pandoc/data/templates/

```
mv eisvogel.tex eisvogel.latex
cp eisvogel.latex -t /usr/share/pandoc/data/templates/
```
